...
printt("The project folder needs to contain a music file, a timestamp file, and another folder with images/videos.")
if len(sys.argv) < 2:
    printt("Usage: python EasyBeatSync.py /path/to/project-folder")
    printt("No folder path was provided, so EasyBeatSync will try to open the optional GUI folder picker.")
