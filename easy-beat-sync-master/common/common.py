...
def ask_folder(multiple=False):
    ...
    try:
        ...
        stop("Missing dependency: install pywebview or pass the folder path as an argument.")
...
def ask_file(multiple=False):
    ...
    try:
        ...
        stop("Missing dependency: install pywebview or pass the file path as an argument.")
